...
Route::prefix('dokter')->name('dokter.')->middleware(['auth', 'role:dokter'])->group(function () {
    ...
    Route::put('/antrian/panggil/{id}', [DokterAntrianController::class, 'panggil'])->name('antrian.panggil');
    Route::put('/antrian/selesai/{id}', [DokterAntrianController::class, 'selesai'])->name('antrian.selesai');
});