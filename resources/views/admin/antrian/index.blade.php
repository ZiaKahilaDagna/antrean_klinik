                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if($v->status == 'menunggu')
                                    <form action="{{ route('admin.antrian.panggil', $v->id) }}" method="POST" style="display:inline">
                                        @csrf
                                        @method('PUT')
                                ...
                                {{-- TOMBOL DELETE --}}
                                <form action="{{ route('admin.antrian.destroy', $v->id) }}" method="POST" style="display:inline">
                                    @csrf
                                    @method('DELETE')
